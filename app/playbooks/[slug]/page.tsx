...
import { PlaybooksPost as PlaybooksPostType } from '@/lib/types/playbooks.types';

const PlaybooksPost = ({ params }: { params: Promise<{ slug: string }> }) => {
  const resolvedParams = use(params);
  
  // Find the playbooks post by slug from our data layer (synchronous)
  const foundPost = playbooksPosts.find(post => post.slug === resolvedParams.slug);
  const [post, setPost] = useState<PlaybooksPostType | null>(foundPost || null);
