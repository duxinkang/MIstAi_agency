...
const VIDEO_BY_BRAND: Record<
  string,
  { src: string; gradient: string; accent: string }
> = {
  "Poly.app": {
    src: "/videos/poly.mp4",
      ...
      <div className="relative aspect-[4/5] md:aspect-[3/4] w-full rounded-2xl overflow-hidden bg-black">
        {video && !playing && (
          ...
          >
            ...
            <span
              aria-hidden="true"
              className="absolute -right-12 -top-12 w-56 h-56 rounded-full blur-2xl opacity-40"
              style={{
                background:
            ...
            <span className="absolute top-5 left-5 flex items-center gap-2 rounded-full bg-white/95 backdrop-blur px-3.5 py-1.5 text-xs font-bold text-ink shadow-md">
