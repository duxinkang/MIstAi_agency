    ...
    <Section bg="ink" className="!py-24 md:!py-32 relative overflow-hidden">
      ...
      <Container size="full" className="relative">
        ...
        >
          ...
          <div className="text-[#00E676] text-xs md:text-sm font-bold tracking-[0.25em] uppercase mb-4">
            {t("category")}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-7">
            {workstreams.map((ws, i) => (
              <motion.div
                ...
                className="rounded-2xl bg-white/[0.04] border border-white/10 p-7 md:p-8 hover:border-[#00E676]/40 transition-colors"
              >
                <div className="flex items-baseline gap-3 mb-5">
                  <span className="sp-display text-[#00E676] text-4xl md:text-5xl tabular-nums leading-none">
                    {ws.n}
                  </span>
                ...
                <ul className="space-y-3">
                  {ws.items.map((item) => (
                    ...
                    >
                      <span
                        aria-hidden="true"
                        className="mt-2 shrink-0 w-1 h-1 rounded-full bg-[#00E676]"
                      />
                      <span>{item}</span>
                    </li>
                  ))}
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-60px" }}
          transition={{ duration: 0.6 }}
          className="mt-16 md:mt-20 rounded-3xl bg-gradient-to-br from-[#00E676]/10 via-transparent to-[#00E676]/5 border border-[#00E676]/30 p-8 md:p-10"
        >
          <div className="text-[#00E676] text-xs md:text-sm font-bold tracking-[0.25em] uppercase mb-6">
            {t("resultsEyebrow")}
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {results.map((r, i) => (
              ...
              >
                <div className="sp-display text-[#00E676] text-5xl md:text-6xl leading-none tabular-nums">
                  {r.n}
                </div>
        ...
        >
          <blockquote className="sp-display text-xl md:text-2xl lg:text-3xl text-white leading-snug relative">
            <span
              aria-hidden="true"
              className="absolute -top-6 -left-2 md:-left-8 text-[#00E676]/35 text-6xl md:text-7xl select-none leading-none"
            >
              &ldquo;
            </span>
            {t("quote")}
